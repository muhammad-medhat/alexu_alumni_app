...
class My_admin extends CI_Controller 
{
  ...
  function display_file($inputFileName)
  {
          ...
          $header_row = $rowData;
            ...
            foreach ($rowData[0] as $key=>$value) {
              switch ($key) 
              {
                  ...
                  case $pos_arr['gid_pos'           ]     :  $alumni['gid']     = $this->my_admin_model->get_degid($value); break;
                ...
                //case $pos_arr['bdate_pos'         ]     :  $alumni['bdate'  ]    = $value; break;
                  ...
                  case $pos_arr['honor_pos'         ]     :  $alumni['honor_pos']  = 1; break;
                  default:         break;
                }
          }
          $alumni['fid'] = $fid;
          //if($this->input->post('year_dynamic')
          //  $alumni['year'] = $year;
    ...
    if($insert=='on'){
      ...
      echo "<br>-- $this->count_insert users are made";
    }
